...
<?php $appUser = app_current_user(); ?>

<?php
// Rias: disable legacy massive inline CSS (it overrides responsive fixes and causes duplicate mobile UI).
$__riasDisableHeaderInlineCss = true;
?>
...
<div id="sidebar_menu">
    ...
    <ul class="nav sidebar_menu-list">
        ...
        <li class="nav-item">
            ...
            <div class="sidebar_menu-sub show" id="sidebar_subs_status">
                <ul class="nav sub-menu color-list">
                    <li class="nav-item"><a class="nav-link" href="<?=$websiteUrl?>/status/completed" title="Completed">Completed</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?=$websiteUrl?>/status/ongoing" title="Ongoing">Ongoing</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <div class="nav-link" title="Latest"><strong><i class="fa fa-angle-down"></i> Latest</strong></div>
            <div class="sidebar_menu-sub show" id="sidebar_subs_latest">
                <ul class="nav sub-menu color-list">
                    <li class="nav-item"><a class="nav-link" href="<?=$websiteUrl?>/latest/subbed" title="Subbed">Subbed</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?=$websiteUrl?>/latest/dubbed" title="Dubbed">Dubbed</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?=$websiteUrl?>/latest/chinese" title="Chinese">Chinese</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="sidebar_menu-sub show" id="sidebar_subs_other">
                <ul class="nav sub-menu color-list">
...
<div id="header" class="header-home hkx-home-topbar">
    <div class="container hkx-topbar-row">
        <button class="hkx-menu-btn" type="button" id="mobile_menu" aria-label="Open menu">
            <i class="fas fa-bars"></i>
        </button>
        <a class="hkx-brand" href="<?=$websiteUrl?>/home"><?php echo $websiteTitle?></a>
        <div class="hkx-search-wrap">
            <form class="hkx-search-form" method="get" action="<?=$websiteUrl?>/search" autocomplete="off">
                <input type="text" class="search-input" name="keyword" id="searching" placeholder="Search anime..." required>
                <button type="button" aria-label="Search icon"><i class="fas fa-search"></i></button>
                <button type="submit" class="hkx-filter-btn">Filter</button>
            </form>
        </div>
        <div class="hkx-quick-links">
            <a href="<?=$discord?>" target="_blank" class="hkx-circle-link discord" rel="noopener noreferrer"><i class="fab fa-discord"></i></a>
            <a href="<?=$telegram?>" target="_blank" class="hkx-circle-link telegram" rel="noopener noreferrer"><i class="fab fa-telegram-plane"></i></a>
            <a href="<?=$redit?>" target="_blank" class="hkx-circle-link reddit" rel="noopener noreferrer"><i class="fab fa-reddit-alien"></i></a>
            <a href="<?=$twitter?>" target="_blank" class="hkx-circle-link twitter" rel="noopener noreferrer"><i class="fab fa-twitter"></i></a>
            <a href="<?=$websiteUrl?>/popular" class="hkx-plain-link"><i class="fas fa-heart"></i><span>Favorites</span></a>
            <a href="<?=$websiteUrl?>/latest/subbed" class="hkx-plain-link"><i class="fas fa-language"></i><span>Language</span></a>
            <a href="<?=$discord?>" target="_blank" class="hkx-plain-link" rel="noopener noreferrer"><i class="fas fa-comments"></i><span>Community</span></a>
            <?php if ($appUser): ?>
                <?php if (($appUser['role'] ?? '') === 'admin'): ?><a href="<?=$websiteUrl?>/admin/index.php" class="hkx-login-btn">Admin</a><?php endif; ?>
                <a href="<?=$websiteUrl?>/profile.php" class="hkx-login-btn"><?=app_e($appUser['username'])?></a>
            <?php else: ?>
                <a href="<?=$websiteUrl?>/login.php" class="hkx-login-btn">Login</a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
:root {
  ...
  --border-soft: rgba(255, 46, 99, 0.2);
}
...
body {
  background: radial-gradient(circle at top, #1a0a0f, #0b0b0f 60%) !important;
...
.btn-primary {
  background: linear-gradient(135deg, #e50914, #ff2e63) !important;
...
.btn-secondary:hover {
  background: var(--bg-card-lift) !important;
}
...
.btn-tab {
    background: var(--bg-card-hover) !important;
    border-color: var(--bg-card-hover) !important;
    color: #fff
}
...
.btn-tab:hover {
    background: var(--bg-card-lift) !important;
    border-color: var(--bg-card-lift) !important
}
...
.header_right-user.logged .dropdown-menu .grid-menu .dropdown-item:hover {
    background-color: var(--bg-card-lift) !important
}
...
.flw-item .film-poster .film-poster-ahref:after {
    ...
    z-index: 1;
    background: var(--bg-secondary);
    background: linear-gradient(0deg, var(--bg-secondary) 0, rgba(18,18,26,0.7) 100%)
}
...
.film_list .film_list-wrap .flw-item .film-poster:after {
    ...
    z-index: 2;
    background: var(--bg-secondary);
    background: -moz-linear-gradient(0deg, var(--bg-secondary) 0, rgba(18,18,26,0) 76%);
    background: -webkit-linear-gradient(0deg, var(--bg-secondary) 0, rgba(18,18,26,0) 76%);
    background: linear-gradient(0deg, var(--bg-secondary) 0, rgba(18,18,26,0) 76%)
}
...
#footer {
    padding: 0 0 0;
    position: relative;
    background: var(--bg-secondary) url(/files/images/footer.jpg) top center no-repeat
}
...
.premodal-login .modal-content {
    background: var(--bg-secondary) url(/theme/6anime/assets/images/login.jpg) top center no-repeat;
    padding-top: 30px
}
...
.premodal-filter .modal-content {
    background: var(--bg-secondary) url(/theme/6anime/assets/images/filter.jpg) top center no-repeat
}
...
.deslide-item .deslide-cover .deslide-cover-img:before {
    ...
    bottom: 0;
    background: var(--bg-main);
    background: -moz-linear-gradient(90deg, var(--bg-main) 0, rgba(32, 33, 37, .6) 40%, rgba(32, 33, 37, 0) 60%, rgba(32, 33, 37, 0) 80%, var(--bg-main) 100%);
    background: -webkit-linear-gradient(90deg, var(--bg-main) 0, rgba(32, 33, 37, .6) 40%, rgba(32, 33, 37, 0) 60%, rgba(32, 33, 37, 0) 80%, var(--bg-main) 100%);
    background: linear-gradient(90deg, var(--bg-main) 0, rgba(32, 33, 37, .6) 40%, rgba(32, 33, 37, 0) 60%, rgba(32, 33, 37, 0) 80%, var(--bg-main) 100%)
}
...
.deslide-item .deslide-cover .deslide-cover-img:after {
    ...
    bottom: 0;
    background: var(--bg-main);
    background: -moz-linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 50%, var(--bg-main) 100%);
    background: -webkit-linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 50%, var(--bg-main) 100%);
    background: linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 50%, var(--bg-main) 100%);
    z-index: 2
}
...
.no-content-block {
    ...
    background: #33353c;
    background: -moz-linear-gradient(0deg, rgba(51, 53, 60, 0) 0, #33353c 50%, #33353c 100%);
    background: -webkit-linear-gradient(0deg, rgba(51, 53, 60, 0) 0, #33353c 50%, #33353c 100%);
...
.actor-cover:before {
    ...
    top: 0;
    background: var(--bg-main);
    background: -moz-linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 100%);
    background: -webkit-linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 100%);
    background: linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 100%)
}
...
.dt-comment:before {
    ...
    width: 70px;
    height: 70px;
    background-image: url(/theme/6anime/assets/images/talk.png);
    background-size: cover;
    position: absolute;
    right: 30px;
    bottom: 0
...
.trending-list .item .number {
    ...
    cursor: default;
    background: var(--bg-card-hover);
    background: -moz-linear-gradient(180deg, var(--bg-card-hover) 0, rgba(74, 75, 81, 0) 99%);
    background: -webkit-linear-gradient(180deg, var(--bg-card-hover) 0, rgba(74, 75, 81, 0) 99%);
    background: linear-gradient(180deg, var(--bg-card-hover) 0, rgba(74, 75, 81, 0) 99%)
}
...
.no-content-block {
    ...
    padding: 100px 0;
    background: var(--bg-secondary);
    background: linear-gradient(0deg, rgba(18,18,26,0) 0, var(--bg-secondary) 100%)
}
...
.dub-icon.dub-icon-02 {
    background-image: url(/theme/6anime/assets/images/dub-icon-02.png);
    width: 100px;
    height: 100px
}
...
.livestream_body {
    background: #0f1631 url(/theme/6anime/assets/images/live-bg.jpg) bottom center repeat-x
}
...
.zicon.zicon-live {
    background-image: url(/theme/6anime/assets/images/live.svg)
}
...
.new-mes {
    ...
    background: #1e76ff;
    color: #fff;
    box-shadow: 0 0 10px 5px rgba(10, 13, 26, .6);
    animation: load-mes .5s linear infinite
}
...
.live-thumbnail:before {
    ...
    width: 100%;
    height: 100%;
    background: url(/theme/6anime/assets/images/live-thumb.png) repeat;
    z-index: 2
}
...
#toast-container>div.toast-success:before {
    background-image: url(/theme/6anime/assets/images/toast-success.svg)
}
...
#toast-container>div.toast-warning:before {
    background-image: url(/theme/6anime/assets/images/toast-warning.svg)
}
...
#toast-container>div.toast-info:before {
    background-image: url(/theme/6anime/assets/toast-info.svg)
}
...
.swiper-lazy-preloader-white:after {
    background-image: url(data:image/svg+xml;charset=utf-8;base64,)
}
...
/* FIX 4 — REMOVE HORIZONTAL SCROLL FOREVER */
...
@media screen and (max-width:759px) {
    ...
    .deslide-item .deslide-cover .deslide-cover-img:after {
        background: var(--bg-main);
        background: -moz-linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 82%);
        background: -webkit-linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 82%);
        background: linear-gradient(0deg, var(--bg-main) 0, rgba(32, 33, 37, 0) 82%)
    }
...
@media screen and (max-width:575px) {
    ...
    .trending-list .item .number {
        ...
        left: 0;
        height: 30px;
        border-radius: 1px 17px 1px 25px;
        background: #fff;
        z-index: 9
    }
...
@media screen and (max-width:479px) {
    ...
    .choose-thumbnail .lv-list .item.active .live-thumbnail:before {
        display: none
    }
...
#sixanime {
    background: #121315 url(/theme/6anime/assets/images/<?=$websiteTitle?>.gif) no-repeat center;
    height: 100%;
    width: 100%;
    position: fixed;
    top: 0;
...
/* Final override: keep shared header identical to homepage topbar */
#header.hkx-home-topbar {
  position: fixed !important;
  top: 0 !important;
  left: 0 !important;
  right: 0 !important;
  ...
  background: linear-gradient(180deg, rgba(12, 12, 20, .95), rgba(12, 12, 20, .7)) !important;
}

#header.hkx-home-topbar .container.hkx-topbar-row {
...
#header.hkx-home-topbar #mobile_menu.hkx-menu-btn {
  position: relative !important;
  top: auto !important;
  left: auto !important;
...
#header.hkx-home-topbar .hkx-brand {
  display: inline-flex !important;
  align-items: center !important;
  margin: 0 !important;
  float: none !important;
...
#header.hkx-home-topbar .hkx-search-wrap {
  flex: 1 1 auto !important;
  min-width: 280px !important;
  margin: 0 !important;
}

#header.hkx-home-topbar .hkx-search-form {
  display: flex !important;
  align-items: center !important;
  width: 100% !important;
...
#header.hkx-home-topbar .hkx-search-form .search-input {
  flex: 1 1 auto !important;
...
#header.hkx-home-topbar .hkx-search-form .search-input::placeholder {
  color: #6b7280 !important;
}

#header.hkx-home-topbar .hkx-search-form button {
  border: 0 !important;
  background: transparent !important;
  box-shadow: none !important;
}

#header.hkx-home-topbar .hkx-filter-btn {
...
#header.hkx-home-topbar .hkx-quick-links {
...
#header.hkx-home-topbar .hkx-circle-link {
  width: 44px !important;
  height: 44px !important;
  min-width: 44px !important;
}

#header.hkx-home-topbar .hkx-plain-link {
  min-width: 66px !important;
  text-align: center !important;
}

#header.hkx-home-topbar .hkx-login-btn {
  display: inline-flex !important;
  align-items: center !important;
  justify-content: center !important;
...
/* =========================================
   ANIKAMI RESPONSIVE MOBILE HEADER
========================================= */
